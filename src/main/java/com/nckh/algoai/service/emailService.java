...
public class emailService {
    ...
    public void sendOtpEmail(String email, String otp) {
        try {
            ...
            helper.setFrom("aigoaitutor@gmail.com", "AlgoAI Coach Support");
            helper.setTo(email);
            helper.setSubject("[AlgoAI] Mã xác thực OTP của bạn");
            ...
            try {
                String template = new String(getClass().getResourceAsStream("/email/otp-template.html").readAllBytes());
